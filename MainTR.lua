...
-- Global Yapılandırma Durumları
_G.SelectedPlayer = "Otomatik"
_G.SelectedPlot = "Plot1"
_G.SelectedLabubu = "Herhangi (Rastgele)"
_G.AutoTakeRunning = false
_G.KeepLabubus = false
_G.SafeMode = true
_G.UsePhysicalInput = true -- TOGGLE: true = Tuş/Dokunma, false = Doğrudan Tetikleme
_G.SellCooldown = 50
_G.TweenSpeed = 350
...
-- Karakter ve Hareket Yardımcıları
...
local function initializeQueue()
    ...
    if npcFolder then
        for _, npc in ipairs(npcFolder:GetChildren()) do
            if _G.SelectedLabubu == "Herhangi (Rastgele)" or npc.Name == _G.SelectedLabubu then
...
-- 1. Ana Merkez Penceresi
local hubFrame, hubCloseBtn = createBaseWindow("Otomatik-Alım Merkezi", UDim2.new(0, 190, 0, 130), UDim2.new(0.02, 0, 0.2, 0))
...
-- 2. Ayarlar Penceresi (Türkçe)
local settingsFrame, settingsCloseBtn = createBaseWindow("Script Ayarları", UDim2.new(0, 230, 0, 360), hubFrame.Position)
...
playerBox.Text = "Hedef Oyuncu: Otomatik"
...
playerBox.FocusLost:Connect(function()
    ...
    playerBox.Text = "Hedef Oyuncu: " .. _G.SelectedPlayer
end)
...
inputModeBtn.Text = "Girdi: Fiziksel (Tuş/Dokunma)"
...
inputModeBtn.MouseButton1Click:Connect(function()
    ...
    if _G.UsePhysicalInput then
        ...
        inputModeBtn.Text = "Girdi: Sanal Etkileşim"
...
plotBtn.Text = "Arsa: " .. _G.SelectedPlot .. " ▼"
...
local labubuList = {"Herhangi (Rastgele)", "Labubu", "Gold Labubu", "Diamond Labubu"}
...
safeBtn.MouseButton1Click:Connect(function()
    ...
    safeBtn.Text = _G.SafeMode and "Güvenli Mod: AÇIK" or "Güvenli Mod: KAPALI"
...
keepBtn.Text = "Labubuları Sakla: KAPALI"
...
keepBtn.MouseButton1Click:Connect(function()
    ...
    keepBtn.Text = _G.KeepLabubus and "Labubuları Sakla: AÇIK" or "Labubuları Sakla: KAPALI"
...
speedBox.Text = "Tween Hızı: " .. tostring(_G.TweenSpeed)
...
sellBox.Text = "Satış Gecikmesi (sn): " .. tostring(_G.SellCooldown)
...
runBtn.Text = "▶ Otomatik-Alımı Başlat"
...
stopBtn.Text = "⏹ Otomatik-Alımı Durdur"
